...
import { Building2, DatabaseZap, FileCheck2, FileClock, Languages, ListTree, Percent, PlugZap, Shield, SlidersHorizontal, Tags, Workflow } from 'lucide-react';
...
const ITEMS = [
  ...
  { icon: DatabaseZap, title: '数据产品价目表', desc: '开放平台接口标准价（数据API套餐报价依据）', path: '/settings/api-prices', perm: 'system.dict' },
